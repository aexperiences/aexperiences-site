...
(function (root) {
  ...
  var CATALOG = [
    ...
    { id:'abode', mark:'/os-icons/Abode_OS.png', name:'Abode OS', img:'/Abode_OS.png', tag:'Real estate', genre:'business', state:'live',
      tiers:[ ['Core',450,0,'Pipeline + CRM + commissions, DeepSeek AI'], ['Elite',950,0,'Full suite + broker views + marketing + Claude'], ['Mothership',2400,0,'Multi-team · compliance · custom + premium AI'] ],
      acc:'#c8794f', url:'/apps/abode/', pricing:'/shop.html#abode',
    ...
    { id:'buttress', mark:'/os-icons/Buttress_OS.png', name:'Buttress OS', img:'/Buttress_OS.png', tag:'Architecture', genre:'business', state:'live',
      tiers:[ ['Core',550,0,'Projects + RFIs + billing + Detail Studio'], ['Elite',1200,0,'Full suite + custom workflows + Claude eyes'], ['Mothership',2800,0,'Unlimited + custom modules + white-glove'] ],
      acc:'#5c8a5f', url:'/apps/buttress/', pricing:'/shop.html#buttress',
    ...
    { id:'truss', mark:'/os-icons/Truss_OS.png', name:'Truss OS', img:'/Truss_OS.png', tag:'Engineering', genre:'business', state:'live',
      tiers:[ ['Core',650,0,'Projects + submittals + Calc Studio'], ['Elite',1400,0,'Full suite + QA + premium AI eyes'], ['Mothership',3200,0,'Unlimited + custom + priority SLA'] ],
      acc:'#18b0ba', url:'/apps/truss/', pricing:'/shop.html#truss',
    ...
    { id:'musical', mark:'/os-icons/Musical_OS.png', name:'Musical OS', img:'/Musical_OS.png', tag:'Live theater', genre:'business', state:'live',
      tiers:[ ['Core',650,0,'Box office + productions + patrons'], ['Elite',1500,0,'+ subscriptions · marketing · full house tools'], ['Mothership',3200,0,'Multi-venue + custom + premium AI'] ],
      acc:'#e0b24a', url:'/apps/musical/', pricing:'/shop.html#musical',
    ...
    { id:'8mm', mark:'/os-icons/8mm_OS.png', name:'8mm OS', img:'/8mm_OS.png', tag:'Film & production', genre:'business', state:'live',
      tiers:[ ['Core',500,0,'Box office + showtimes + members'], ['Elite',1200,0,'Up to 8 screens + reserved + concessions'], ['Mothership',2800,0,'Multi-location + custom + premium AI'] ],
      acc:'#8a6fd6', url:'/apps/8mm/', pricing:'/shop.html#8mm',
    ...
    { id:'amphitheater', mark:'/os-icons/Amphitheater_OS.png', name:'Amphitheater OS', img:'/Amphitheater_OS.png', tag:'Concerts & venues', genre:'business', state:'live',
      tiers:[ ['Core',600,0,'Box office (GA/reserved/cabaret) + lineup'], ['Elite',1400,0,'Full suite + marketing + memberships'], ['Mothership',3000,0,'Multi-venue + custom + priority SLA'] ],
      acc:'#d65f8a', url:'/apps/amphitheater/', pricing:'/shop.html#amphitheater',
    ...
    { id:'lilninja', mark:'/os-icons/LilNinja_OS.png', name:'LilNinja OS', img:'/LilNinja_OS.png', tag:'Kids gyms & programs', genre:'business', state:'live',
      tiers:[ ['Core',400,0,'Schedule + enrollment + tuition + families'], ['Elite',750,0,'Full suite + coaches + parent portal + your site'], ['Mothership',1600,0,'Multi-site + custom + premium AI'] ],
      acc:'#4aa3d6', url:'/apps/lilninja/', pricing:'/shop.html#lilninja',
    ...
    { id:'moments', mark:'/os-icons/Moments_OS.png', name:'Moments OS', img:'/Moments_OS.png', tag:'Photographers & videographers', genre:'business', state:'live',
      tiers:[ ['Core',99,0,'One person \u2014 shoots, clients, contracts, galleries, invoices, and the video editor'], ['Elite',199,0,'A second shooter, print sales, usage licensing and a branded client portal'], ['Mothership',329,0,'Commercial work \u2014 larger storage, your own domain, a dedicated environment'] ],
      acc:'#6b5bb5', url:'/apps/moments/', pricing:'/shop.html#moments',
    ...
    { id:'smiley', mark:'/os-icons/Smiley_OS.png', name:'Smiley OS', img:'/Smiley_OS.png', tag:'Dental practices', genre:'business', state:'live',
      tiers:[ ['Core',350,0,'One doctor and a hygiene chair \u2014 the whole system where the owner is also the office manager'], ['Elite',750,0,'Two to four operatories with an office manager \u2014 insurance verification and claims aging come in here'], ['Mothership',1500,0,'Multi-provider, multi-location, the ortho module switched on, branded patient portal'] ],
      acc:'#0e7c93', url:'/apps/smiley/', pricing:'/shop.html#smiley',
    ...
    { id:'sleeves', mark:'/os-icons/Sleeves_OS.png', name:'Sleeves OS', img:'/Sleeves_OS.png', tag:'Tattoo studios', genre:'business', state:'live',
      tiers:[ ['Core',250,0,'A single artist \u2014 the whole system for someone who is also the front desk'], ['Elite',650,0,'A real shop with booth renters \u2014 books, metrics and the AI department org'], ['Mothership',1400,0,'Multi-location, guest artists, dedicated environment, branded booking site'] ],
      acc:'#b8324a', url:'/apps/sleeves/', pricing:'/shop.html#sleeves',
    ...
    { id:'toolbelt', mark:'/os-icons/Toolbelt_OS.png', name:'Toolbelt OS', img:'/Toolbelt_OS.png', tag:'HVAC \u00b7 plumbing \u00b7 electrical', genre:'business', state:'live',
      tiers:[ ['Core',450,0,'1\u20133 trucks \u2014 the whole system for an owner still turning wrenches'], ['Elite',950,0,'A real shop with a dispatcher \u2014 referral CRM, recruiting, books, agent org'], ['Mothership',2200,0,'Multi-location, multi-trade, dedicated environment, branded tech app'] ],
      acc:'#e4832b', url:'/apps/toolbelt/', pricing:'/shop.html#toolbelt',
    ...
    { id:'stayathome', mark:'/os-icons/StayAtHome_OS.png', name:'Stay@Home OS', img:'/StayAtHome_OS.png', tag:'Home care agencies', genre:'business', state:'live',
      tiers:[ ['Core',550,0,'One office \u2014 the whole system, sized for a single territory'], ['Elite',1150,0,'Multi-office + referral CRM + books + the AI department org'], ['Mothership',2600,0,'Multi-state + dedicated environment + migration + branded caregiver app'] ],
      acc:'#2e7f7c', url:'/apps/stayathome/', pricing:'/shop.html#stayathome',
    ...
    { id:'4barrel', mark:'/os-icons/4barrel_OS.png', name:'4barrel OS', img:'/4barrel_OS.png', tag:'Used-car dealers', genre:'business', state:'live',
      tiers:[ ['Core',450,0,'Inventory + desk + leads + recon'], ['Elite',950,0,'Full suite + online sales + service'], ['Mothership',2000,0,'Multi-lot + custom + premium AI'] ],
      acc:'#1c5568', url:'/apps/4barrel/', pricing:'/shop.html#4barrel',
    ...
    { id:'targeted', mark:'/os-icons/Targeted_OS.png', name:'Targeted OS', img:'/Targeted_OS.png', tag:'Marketing agencies & studios', genre:'business', state:'live',
      tiers:[ ['Core',450,0,'CRM + pipeline + estimator + campaigns'], ['Elite',950,0,'Full suite + agent org + mail + Connect'], ['Mothership',2200,0,'Multi-team + custom + premium AI'] ],
      acc:'#d97a2e', url:'/apps/targeted/dashboard', pricing:'/shop.html#targeted',
    ...
    { id:'espowho', name:'ESPOwho', tag:'Twenty questions, out loud', genre:'games', state:'live',
      acc:'#c8794f', mark:'/marks/espowho.svg', family:'ESPOparlor', url:'/apps/espowho/', age:'Kids',
      blurb:'Think of somebody and it guesses who. Mario, Pikachu, Bluey, Michael Jordan, a shark. It reads every word out loud and lights each word as it says it, and kids can answer out loud too, so it works before they can read. Eight hundred characters, nine worlds, and three sizes so a six year old and a twelve year old play the same game. On your own, or with a friend on a four letter code.',
      price:'Free', priceNote:'A free kids game. No ads, no accounts, nothing collected.' },
    ...
    { id:'ae-fraud-division', name:'AE Fraud Division', tag:'Fraud screening for banks', genre:'work', state:'live', aisles:['business'],
      ...
      price:'$1,495/mo flat', priceNote:'Never per-seat \u2014 the whole institution, one price. Open it and run a real screen right now; payments not switched on yet.' },
 { id:'ae-blastpack', name:'AE Blastpack', tag:'Post everywhere at once', genre:'social', state:'dev',
  ...
  var MEDIA = {
    ...
    moments:     { preview:'/media/moments/preview.mp4', poster:'/media/moments/poster.jpg', len:'2:57',
                 ...
                 long:'/media/moments/long.mp4', longPoster:'/media/moments/long-poster.jpg', longLen:'5:04' },
    smiley:      { preview:'/media/smiley/preview.mp4', poster:'/media/smiley/poster.jpg', len:'2:53',
                 ...
                 long:'/media/smiley/long.mp4', longPoster:'/media/smiley/long-poster.jpg', longLen:'5:52' },
