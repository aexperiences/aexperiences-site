...
(function (root) {
  ...
  var CATALOG = [
    ...
    { id:'datum', name:'Truss OS', img:'/Truss_OS.png', tag:'Engineering', genre:'business', state:'live',
    ...
    { id:'reel', name:'8mm OS', img:'/8mm_OS.png', tag:'Film & production', genre:'business', state:'live',
    ...
    { id:'encore', name:'Amphitheater OS', img:'/Amphitheater_OS.png', tag:'Concerts & venues', genre:'business', state:'live',
    ...
    { id:'cartwheel', name:'LilNinja OS', img:'/LilNinja_OS.png', tag:'Kids gyms & programs', genre:'business', state:'live',
    ...
    { id:'showroom', name:'4barrel OS', img:'/4barrel_OS.png', tag:'Used-car dealers', genre:'business', state:'live',
