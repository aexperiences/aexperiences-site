/* ESPOsign service worker — offline-first, caches the PDF libraries too.
   Accelerated Experiences, LLC */
var C = "esposign-v2";
var ASSETS = [
  "./", "./index.html", "./icon.png", "./manifest.webmanifest",
...
self.addEventListener("activate", function (e) {
  e.waitUntil(caches.keys().then(function (ks) {
    return Promise.all(ks.filter(function (k) { return k.indexOf("esposign-") === 0 && k !== C; }).map(function (k) { return caches.delete(k); }));
