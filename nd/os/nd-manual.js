...
{c:'rooms',t:'Helper: just ask',g:'helper assistant ask question talk voice microphone speak help writing hear',b:'Your own helper lives in the Helper room. Ask it anything: help starting a post, making a draft sound like you, a question about a kid, or how a room in your office works. Type it, or tap the microphone and say it. Your words land in the box first so you can fix them before you tap Ask. Tap Hear it and Roz reads the answer out loud. Copy puts the answer on your clipboard. The conversation stays on your device. New talk clears it. Leave readers emails, phone numbers and addresses out; the helper will not send them. For a call between the two schools of thought, use your Quality room.'},
