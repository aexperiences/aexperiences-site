...
(function (root) {
  ...
  var TRADES = {
    ...
    realestate: {
      id:'realestate', hub:'Abode OS', trade:'Real estate',
    ...
    architecture: {
      id:'architecture', hub:'Buttress OS', trade:'Architecture', acc:'#5c8a5f', acc2:'#43703f',
    ...
    engineering: {
      id:'engineering', hub:'Truss OS', trade:'Engineering', acc:'#18b0ba', acc2:'#0f8a92',
    ...
    theater: {
      id:'theater', hub:'Musical OS', trade:'Live theater', acc:'#e0b24a', acc2:'#b8902f',
    ...
    cinema: {
      id:'cinema', hub:'8mm OS', trade:'Cinema', acc:'#8a6fd6', acc2:'#6b52b0',
    ...
    concerts: {
      id:'concerts', hub:'Amphitheater OS', trade:'Concerts & venues', acc:'#d65f8a', acc2:'#b04068',
    ...
    kidsgym: {
      id:'kidsgym', hub:'LilNinja OS', trade:'Kids gyms & programs', acc:'#4aa3d6', acc2:'#3480ad',
